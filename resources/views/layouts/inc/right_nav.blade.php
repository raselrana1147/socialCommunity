        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{asset('front/img/avatar/20.jpg')}}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline away">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{asset('front/img/avatar/05.jpg')}}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{asset('front/img/avatar/09.jpg')}}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{asset('front/img/avatar/12.jpg')}}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline away">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{asset('front/img/avatar/10.jpg')}}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline offline">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{asset('front/img/avatar/02.jpg')}}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{asset('front/img/avatar/08.jpg')}}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{asset('front/img/avatar/14.jpg')}}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
