        ...
        <div class="sidebar-menu">
            ...
            <div class="sidebar-menu-item">
                ...
                <div class="sidebar-menu-body accordion-content-linked accordion-open">
                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link active" href="{{ route('user.profile.info') }}">Profile Info</a>
                    <!-- /SIDEBAR MENU LINK -->
                    ...
                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link" href="{{ route('user.order.history') }}">My Orders</a>
                    <!-- /SIDEBAR MENU LINK -->
            ...
            <div class="sidebar-menu-item">
                ...
                <div class="sidebar-menu-body accordion-content-linked">
                    ...
                    <!-- SIDEBAR MENU LINK -->
                    <a class="sidebar-menu-link" href="{{ route('user.profile.manage-item') }}">Manage Items</a>
                    <!-- /SIDEBAR MENU LINK -->
