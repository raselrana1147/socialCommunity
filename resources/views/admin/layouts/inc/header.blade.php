 <div class="page-main-header">
        <div class="main-header-right row m-0">
          ...
          <div class="main-header-left">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{asset('assets/admin/assets/images/logo/logo.png')}}" alt=""></a></div>
          ...
          <div class="nav-right col-8 pull-right right-menu">
            <ul class="nav-menus">
              ...
              <li class="profile-nav onhover-dropdown p-0">
                <div class="media profile-media"><img class="b-r-10 avatar-admin" src="{{((Auth::guard('admin')->user()->avatar !=null) ? asset('/assets/admin/style/image/admin/'.Auth::guard('admin')->user()->avatar) : asset('assets/admin/style/image/admin/profile.png')) }}" alt="" >
                  <div class="media-body"><span>{{Auth::guard('admin')->user()->name}}</span>
                    <p class="mb-0 font-roboto">{{Auth::guard('admin')->user()->role}}<i class="middle fa fa-angle-down"></i></p>
                  </div>
                </div>
                <ul class="profile-dropdown onhover-show-div">
                  <li><i data-feather="user"></i><a href="{{ route('admin.profile') }}"><span style="color: #000">Account </span></a></li>
                  <li><i data-feather="log-in"> </i><span role="button" onclick="event.preventDefault();
                                   document.getElementById('logout-form-admin').submit();">Logout</span></li>
